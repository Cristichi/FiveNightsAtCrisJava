...
public class RoamingBob extends AvoidCamsAnimatronicDrawing {
    ...
    public RoamingBob(String name, Map<Integer, Integer> aiDuringNight, boolean cameraStalled,
        ...
        super(name,
                "Bob starts at the Storage, and moves randomly to any place except corridor 2.",
                "Bob moves randomly, always avoiding cam4 and your right door. He can still move to cam2.",
                5, 6, aiDuringNight, 20, cameraStalled, globalCameraStalled, "anims/bob/camImg.png",
