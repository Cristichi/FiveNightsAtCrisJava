...
public class Nights extends JFrame {
    ...
    private Night startSandboxNight() throws IOException {
        ...
        if (Main.DEBUG_TEST_NIGHT_MODE){
            ...
            ((CrisRestaurantMap) nightMap).addCamAnimatronics("corridor 1",
                    //new Bob(1, Map.of(0, 20), false, List.of("cam4"), 555),
                    //new Maria(1, Map.of(0,0), false, List.of(), 5),
                    //new RoamingCris(1, Map.of(0,20), true, List.of("kitchen", "storage", "main stage", "dining area"), 5, rng)
                    new RoamingCris(3, Map.of(0,20), true, List.of(), 3, rng)
                    ///new Paco(4, Map.of(0,20), false, List.of("kitchen", "dining area", "corridor 1", "corridor 3", "leftDoor"), "kitchen", 1f, 555)
            );
        } else {
            nightMap = new TutorialMap();
            ((TutorialMap) nightMap).addCamAnimatronics("leftDoor",
                    //new Bob(5, Map.of(0, 20), false, List.of("cam2", "cam4"), 1)
                    //new Maria(1, Map.of(0,0), false, List.of(), 3)
                    new RoamingCris(2, Map.of(0,20), true, List.of(), 1, rng)
                    //new Paco(4, Map.of(0,20), false, List.of("cam1", "cam2", "cam4", "rightDoor"), "cam1", 1f, 1)
            );
        }
    ...
    private Night startTutorialNight(SaveFileIO.SaveFile saveFile) throws IOException {
        ...
        tutorialMap.addCamAnimatronics("cam1", new RoamingBob(5, aiNightBob, false, List.of("cam4"), 8));
        tutorialMap.addCamAnimatronics("cam2", new RoamingMaria(5, aiNightMaria, false, List.of("cam3"), 8));
    ...
    private Night startNight1(SaveFileIO.SaveFile saveFile) throws IOException {
        AnimatronicDrawing bob = new RoamingBob(5, Map.of(0,1, 4,2), false,
                List.of("corridor 2", "corridor 4", "bathrooms", "offices"), 6);

        AnimatronicDrawing maria = new RoamingMaria(5, Map.of(4,1), false,
                List.of("corridor 1", "corridor 3", "staff lounge"), 6);

        AnimatronicDrawing paco = new Paco(6, Map.of(0,2, 4,3), false,
                List.of(
    ...
    private Night startNight2(SaveFileIO.SaveFile saveFile) throws IOException {
        long seed = new Random().nextLong();
        Random rng = new Random(seed);
        AnimatronicDrawing bob = new RoamingBob(5, Map.of(0,4), false,
                List.of("corridor 2", "corridor 4", "bathrooms", "offices"), 5);

        AnimatronicDrawing maria = new RoamingMaria(5, Map.of(1,1, 4,2), false,
                List.of("corridor 1", "corridor 3", "staff lounge"), 5);

        AnimatronicDrawing paco = new Paco(6, Map.of(0,4, 4,5), false,
                List.of(
                        List.of("kitchen", "dining area", "corridor 1", "corridor 3", "leftDoor"),
                        List.of("kitchen", "dining area", "corridor 2", "corridor 4", "rightDoor")
                ), 1f, 5);

        AnimatronicDrawing crisIsClose = new RoamingCris(5, Map.of(0,1, 4,2, 5,3), true,
    ...
    private Night startNight3(SaveFileIO.SaveFile saveFile) throws IOException {
        ...
        AnimatronicDrawing bob = new RoamingBob(5, Map.of(0,7), false,
                List.of("corridor 2", "corridor 4", "bathrooms", "offices"), 5);

        AnimatronicDrawing maria = new RoamingMaria(5, Map.of(1,3, 4,5), false,
                List.of("corridor 1", "corridor 3", "staff lounge"), 5);

        AnimatronicDrawing paco = new Paco(6, Map.of(0,5, 4,7), false,
                List.of(
                        List.of("kitchen", "dining area", "corridor 1", "corridor 3", "leftDoor"),
                        List.of("kitchen", "dining area", "corridor 2", "corridor 4", "rightDoor")
                ), 1f, 5);

        AnimatronicDrawing crisRandomSideAllNight = new RoamingCris(5, Map.of(0,1, 4,2, 5,3), true,
    ...
    private Night startNight4(SaveFileIO.SaveFile saveFile) throws IOException {
        ...
        AnimatronicDrawing bob = new RoamingBob(5, Map.of(0,8, 4,9), false,
                List.of("corridor 2", "corridor 4", "bathrooms", "offices", "storage", "kitchen"), 5);

        AnimatronicDrawing maria = new RoamingMaria(5, Map.of(0,3, 2,5, 4,6), false,
                List.of("corridor 1", "corridor 3", "staff lounge", "storage", "kitchen"), 5);

        AnimatronicDrawing paco = new Paco(6, Map.of(0,7, 5,8), false,
                List.of(
                        List.of("kitchen", "dining area", "corridor 1", "corridor 3", "leftDoor"),
                        List.of("kitchen", "dining area", "corridor 2", "corridor 4", "rightDoor")
                ), 1f, 5);

        AnimatronicDrawing crisChoosesPathAndTeleports = new PathCris(5, Map.of(0,1, 4,2, 5,4), true,
                List.of(
